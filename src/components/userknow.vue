    ...
    <div>
        ...
        <van-tabs @click="onClick">
            ...
            <van-tab :title="'评论数:'+num">
                    ...
                    <van-skeleton title avatar :row="3" :loading="loading" v-for="(item,index) in text" :key="index" >
                        <div class="van-hairline--bottom" v-if="item.is_top === 1 && item.forid ===null && item.is_two === 0">
                            <van-row type="flex" >
                                ...
                                <van-col span="19">
                                    <p style="display:flex;line-height:2.5rem;color:red;font-size:1.1rem" v-if="item.live === 1">{{item.username}}</p>
                                    <p style="display:flex;line-height:2.5rem;font-size:1.1rem" v-if="item.live !== 1">{{item.username}}</p>
                                    <van-col style="line-height:25px;font-size:8px">{{item.content}}</van-col>
                                </van-col>
                            </van-row>
                            <van-row type="flex"  justify="space-between" style="font-size:5px;">
                                <van-col span="22">
                                    <van-row>
                                        ...
                                        <van-col span="3" @click='submit0(item.uid,item.id)'>
                ...
                <van-row style="padding-top:20px;font-size:5px">
